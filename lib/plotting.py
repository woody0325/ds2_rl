...
def plot_two_episode_stats(stats1, stats2, smoothing_window=10, noshow=False):
    # Plot the episode length over time
    fig1 = plt.figure(figsize=(10,5))
    plt.plot(stats1.episode_lengths, label='stats1')
    ...
    plt.plot(rewards_smoothed1, label='stats1')
    ...
    # Plot time steps and episode number
    fig3 = plt.figure(figsize=(10,5))
    plt.plot(np.cumsum(stats1.episode_lengths), np.arange(len(stats1.episode_lengths)), label='stats1')
